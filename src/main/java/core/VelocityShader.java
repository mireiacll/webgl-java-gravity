...
public class VelocityShader {

    private int program;
    private int positionLoc;
    private int texCoordLoc;
    private int uVelocityLoc;
    private int uPositionTexLoc;
    ...
    public VelocityShader() {
        ...
        uPositionTexLoc = glGetUniformLocation(program, "u_position");
    ...
    private int compile(int type, String source) {
        ...
        if (glGetShaderi(shader, GL_COMPILE_STATUS) == GL_FALSE) {
            System.err.println("Velocity shader compilation failed: " + glGetShaderInfoLog(shader));
            return -1;
        }
        return shader;
    }
    ...
    private int buildProgram() {
        ...
        String fragmentSource = loadResource("/shaders/velocityUpdateFragment.glsl");
        ...
        if (glGetProgrami(prog, GL_LINK_STATUS) == GL_FALSE) {
            System.err.println("Velocity program linking failed: " + glGetProgramInfoLog(prog));
        }
    ...
    public int getUPositionTexLoc() { return uPositionTexLoc; }
